        ...
        <div className="flex md:hidden min-h-screen items-center justify-center text-center px-6">
          <div>
            ...
            <p className="black-text">
              This page isn’t optimized for mobile yet. Please switch to a
...
`}
            ...
            <section className="flex-1 p-6">
              {selectedComponent && selectedComponent?.type === "frontend" && (
                <ComponentDetails component={selectedComponent} />
              )}

              {selectedComponent && selectedComponent?.type === "backend" && (
                <BackendComponentDetails component={selectedComponent} />
              )}

              {!selectedComponent && (
                <p className="text-center black-text">Loading components...</p>
              )}
            </section>
          </main>
        </div>
